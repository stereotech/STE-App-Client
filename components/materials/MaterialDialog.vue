    ...
    >
      <v-card>
        <v-toolbar dark color="primary">
          ...
          <v-toolbar-title v-if="isAdded">{{$t('materials.materialDialog.title')}}</v-toolbar-title>
          <v-toolbar-title v-if="!isAdded">{{$t('materials.materialDialog.updateMaterial')}}</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
            <v-btn dark flat @click="closeDialog(true)">{{$t('frequentlyUsed.save')}}</v-btn>
          </v-toolbar-items>
        </v-toolbar>
