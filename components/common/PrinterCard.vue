  ...
  <v-flex xs12 v-if="computedStatus && computedPrinter">
    <v-card>
      <v-toolbar v-if="toolbar" flat dense color="secondary">
        <v-btn v-if="controlPanel" flat nuxt :to="'/printers/' + id" ripple>{{$t("common.printerCard.title")}}
        ...
        <v-layout row wrap>
              ...
              <v-layout row wrap>
                ...
                <v-flex xs8>
                  ...
                  <p
                    class="title"
                    v-if="isPrinting"
                  >{{$t("common.printerCard.printing")}}{{ computedStatus.progress.completion | currency('', 1) }}%</p>
                  <p
            ...
            <v-container fluid grid-list-md>
              <v-layout row wrap>
                <v-flex :xs3="chamber" :xs4="chamber">
                  <p class="body-1 text-truncate">{{$t("common.printerCard.e2Target")}}</p>
                ...
                <v-flex :xs3="chamber" :xs4="chamber">
                  <p class="body-1 text-truncate">{{$t("common.printerCard.bedTarget")}}</p>
                ...
                <v-flex xs3 v-if="chamber">
                  <p class="body-1 text-truncate">{{$t("common.printerCard.chamberTarget")}}</p>
          ...
          <v-flex d-flex md4 xs12 sm6 v-else>
            <v-btn color="accent" round large depressed>
              <v-icon>mdi-cached</v-icon>{{$t("common.printerCard.tryToReconnect")}}
            </v-btn>
          </v-flex>
            ...
            <v-container fluid grid-list-md>
              <v-layout row wrap v-if="isPrinting || isPaused">
                <v-flex xs12 sm8 md12>
                  <p class="title text-truncate">{{$t("common.printerCard.currentFile")}}</p>
